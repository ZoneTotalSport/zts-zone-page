...
(function (root, factory) {
  ...
  function createPopup() {
    ...
    div.innerHTML = [
      ...
      '    <div style="background:rgba(0,229,255,0.08);border-radius:14px;padding:18px 20px;margin-bottom:8px;">',
      '      <p style="font-family:Patrick Hand,cursive;font-size:1.15rem;color:#ccc;margin:0;line-height:1.6;">',
      '        \u2705 +500 jeux et activit\u00E9s sportives<br>',
      '        \u2705 Outils de planification gratuits<br>',
      '        \u2705 SAE et grilles d\u2019\u00E9valuation<br>',
      '        \u2705 G\u00E9n\u00E9rateur de jeux par IA',
      '      </p>',
      '    </div>',
